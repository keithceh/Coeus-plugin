...
SECTIONS = [
    ...
    ("tools",            "Tools",                ROOT / "docs/Tools.md",                          None),
...
const MAIN_TABS=['readme','ep-council','llm-council','tools','project-lifecycle'];
const SUB_PARENT={
...
const SUB_LABEL={'ep-council':'EP-Council','llm-council':'LLM-Council','tools':'Tools','project-lifecycle':'Project-Lifecycle','readme':'Overview'};
const MD2TAB={
...
<title>Coeus — EP-Council Plugin for Claude</title>
...
<header>
  <div class="wrap">
    <div class="brand">
      <h1>Coeus</h1>
      <span class="v">EP-Council plugin for Claude</span>
    </div>
    <nav>
{nav}
    </nav>
