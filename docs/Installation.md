...
4. Confirm. All 13 skills register — type `/coeus:` in chat to verify.
...
Verify by typing `/coeus:` — you should see a popup listing all 13 skills.
...
You should see a version dir containing `skills/`, `hooks/`, `scripts/`, and `.claude-plugin/`. Then in `claude` type `/coeus:` — the popup should show all 13 skills.
