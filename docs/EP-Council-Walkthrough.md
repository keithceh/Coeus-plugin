...
The Green Team runs the full T0–T12 trap screen. Each trap is reported as CLEAR or ACTIVE.
...
| T10 — Duration Drift | CLEAR | Organic reinvestment funded first |
| T11 — Megaproject Overrun | CLEAR | Exploration phase — below FID scope; re-screen at development sanction |
| T12 — Peak-Price Entry | CLEAR | Farm-in priced on carried exploration cost, not the strip |
