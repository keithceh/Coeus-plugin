...
v1.4.1: after the artefacts index is regenerated, the close protocol offers a Project Atlas refresh (`atlas`) — only when `Outputs/atlas.html` already exists; lifecycle never creates one.
