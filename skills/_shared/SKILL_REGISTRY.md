...
| `coeus-router` | meta | 3 | ~900 | `/coeus:router` | (routes only — the Coeus guru / skill selector: picks the right Tier 1/2 skill across decision / tools / seismic / vault families and launches it via the Skill tool in the same response; v1.4.0 adds the Step-0 gate (BYPASS / NO ROUTE / PROCEED), sequential cross-family routing, three-tier confidence fallback, and the routing golden set in references/) |

**Families.** Coeus skills group into four intent families plus a meta layer:
