...
|---|---|---|---|---|---|
| `llm-council` | decision | 1 | ~2,852 | `/coeus:llm-council` | — |
...
| `coeus-router` | meta | 3 | ~822 | `/coeus:router` | (routes only — picks the right Tier 1/2 skill in either family) |

**Families.** Coeus skills group into two intent families plus a meta layer:

- **decision** — multi-model deliberation, prompt engineering, plugin authoring. Always invoked deliberately by the user.
- **tools** — DOCX mechanics and project lifecycle. Invoked when the user has a concrete file or session-management task.
