...
| `coeus-router` | meta | 3 | ~900 | `/coeus:router` | (routes only — the Coeus guru / skill selector: picks the right Tier 1/2 skill across decision / tools / seismic families and launches it via the Skill tool in the same response, v1.2.0) |
