...
| Asks to evaluate, regression-test, or synthesize routing scenarios for Coeus's own routing ("routing eval", "test coeus routing", "grade routing", "router regression") | `seer` | `/coeus:seer` |
