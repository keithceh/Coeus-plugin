...
description: >-
  ...
  Tier-3 meta-skill router across three families: decision (llm-council, ep-council, morpheus, the-architect, prompt-master, caveman, plugin-creator), tools (ooxml-repair, ooxml-fields, docx-inventory, project-lifecycle), seismic (dug_binary). Use when the user wants a Coeus skill but doesn't know which.
dependencies:
  - llm-council
  - ep-council
  - morpheus
