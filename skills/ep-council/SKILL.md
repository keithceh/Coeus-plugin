...
| T3 | Integration Illusion | TotalEnergies | Integration thesis substituting for standalone economics, or resting on a frontier-stability assumption a single security/legal event can suspend (Mozambique LNG: 4.5-yr force majeure) |
