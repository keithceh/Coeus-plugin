...
## Strategy Gate | Opportunity Intake | Enforcer Selection | 9 Council Members | T0–T9 Traps
...
Phase 2: Strategic Roadmap & Gated Approval ◄── HARD GATE: operator must approve
     │
     ▼
Round 1: Red Team (3 members) → Council Trap Screen T0–T9
     │
     ▼
Round 2: Red Team (3 members) → Council Trap Screen T0–T9
     │
     ▼
Round 3: Red Team (3 members) → Council Trap Screen T0–T9
     │
     ▼
...
After each round: **run Council Trap Screen T0–T9**. Any trap firing must be addressed before the next round begins.

---

## 🔍 COUNCIL TRAP SCREEN (T0–T9)
...
| `/trap-screen` | Run T0–T9 check on demand |
...
*EP-Council Engine v9 · 9 members · T0–T9 traps · 3-3-3 factions · BSL 1.1 · ENERGEIA SERVICES PTE. LTD.*
