...
| `coeus-router` | **Tier-3 meta-skill** — the Coeus guru / skill selector: routes the user's intent to the right Coeus skill and launches it via the Skill tool in the same response, no domain logic (v1.3.0) | `/coeus:router` |
