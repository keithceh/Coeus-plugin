...
Coeus is a **Claude Code plugin** that bundles 16 skills for high-stakes EP-industry decision-making, plugin authoring, meta-routing, upstream subsurface data extraction, direct Obsidian-vault file operations (the **vault** family, v3.16.0), and Minto pyramid-principle document structuring (the **writing** family, v3.19.0):
